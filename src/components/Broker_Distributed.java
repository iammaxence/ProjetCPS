...
/**
 * The class <code> Broker_Distributed </code> represent the 
 * intermediate in a Multi-JVM between publishers and subscriber. 
...
@OfferedInterfaces(offered= {ManagementCI.class,PublicationCI.class, TransfertCI.class})
@RequiredInterfaces(required = {ReceptionCI.class, TransfertCI.class} )
public class Broker_Distributed
...
implements ManagementImplementationI, SubscriptionImplementationI, PublicationsImplementationI, TransfertImplementationI{
	...
	protected Broker_Distributed(int nbThreads, int nbSchedulableThreads, 
				String uri, 
